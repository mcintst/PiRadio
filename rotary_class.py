...
class RotaryEncoder:
	...
	def __init__(self, pinA, pinB, button,callback):
		...
		# Add event detection to the GPIO inputs
			...
			print("Rotary Encoder initialise error {}".format(str(e)))
			sys.exit(1)
...
def volume_event(event):
	...
	print("Volume event {},{}".format(event,name))
	return
...
def tuner_event(event):
	...
	print("Tuner event {}".format(event,name))
	return
...
if __name__ == "__main__":
	...
	print("Up switch GPIO {}".format(up_switch))
	print("Down switch GPIO {}".format(down_switch))
	print("Mute switch GPIO {}".format(mute_switch))
	print("Menu switch GPIO {}".format(menu_switch))
